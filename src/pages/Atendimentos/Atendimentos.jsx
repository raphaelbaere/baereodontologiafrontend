...
import EnhancedTable4 from '../../components/EnhancedTable4';
        ...
        <AppBar position="absolute" open={open}>
          ...
          >
            ...
            <Typography
              ...
              sx={{ flexGrow: 1 }}
            >
              {atendimentos.length > 0 ? `Atendimentos` : '?'}
            </Typography>
          ...
          <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
            <Grid container spacing={3} sx={{ height: '160vh'}}>
              <Grid item xs={12}>
                ...
                <EnhancedTable4 setAtualize2={setAtualize2} treatments={atendimentos} />
                    <Copyright sx={{ pt: 4 }} />
                </Paper>
              </Grid>
            </Grid>
